...
| [Styling & Theming](styling.md) | Tailwind CSS v4 setup, `@custom-variant dark`, custom `@theme` tokens, glassmorphism patterns, background treatment, color conventions, and Motion animations |
